...
function SKIN:PaintScoreboardEntry(panel, w, h)
	...
	draw.SimpleText(ply:GetCharacterName(), "afterglow.labelsmall", h + 4, math.Round(h * 0.33), self.Text.Normal, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	draw.SimpleText(ply:GetShortDescription(), "afterglow.labelsmall", h + 4, math.Round(h * 0.66), self.Text.Disabled, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
